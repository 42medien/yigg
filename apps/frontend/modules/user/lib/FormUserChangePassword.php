 ...
 * @subpackage  user
 */
class FormUserChangePassword extends yiggForm
{
    ...
    $this->setWidgetSchema(
      ...
      $this->setValidatorSchema(
          new sfValidatorSchema(
            array(
             'currentPassword'  => new yiggValidatorPassword(
                 array(
                        'min_length'    => 5,
                        'max_length'   => 45,
                 ),
                 array(
                'required'  => 'Bitte aktuelles Passwort eintragen.',
      ...
      $this->validatorSchema->setPostValidator(
         new sfValidatorSchemaCompare(
          'confirmPassword',
            ...
            'newPassword',
            array(),
            array('invalid'  => 'Passwörter sind nicht identisch.')
