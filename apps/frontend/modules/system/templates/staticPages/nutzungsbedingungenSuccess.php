...
<ul>
  <li>
    ...
    <ul>
      <li>
        <h4>1.1 Allgemeines</h4>

          <p>Diese allgemeinen Nutzungsbedingungen von YiGG GmbH, Steinkirchner Strasse 31 , 81475 München, vertreten durch Michael Reuter („YiGG.de” oder „wir” oder „uns”) gelten für den „Community News &amp; More Dienst” (einschließlich der darin enthaltenen Inhalte), der auf der Internetseite unter der URL <a href="http://yigg.de">http://yigg.de</a> (die „Website”) sowie den dazugehörigen Unterseiten und Zusatzseiten angeboten wird und auf den von der Website verwiesen wird, sowie ggfs. weitere Features, Inhalte oder Anwendungen, die YiGG.de gelegentlich im Zusammenhang mit der Website anbietet (zusammen der „YiGG Dienst”). Hiervon ausgenommen sind ausdrücklich als „Drittdienste” gekennzeichnete Dienstleistungen, die nicht von uns selbst sondern von einem Dritten angeboten werden. Für diese Dienste gelten ausschließlich die von dem Dritten eingestellten allgemeinen Geschäftsbedingungen.
        </p>
      </li>
      <li>
       <h4>1.2 Beschreibung des YiGG Dienstes</h4>
        <p>
        ...
        <p>
          YiGG bietet zudem die Möglichkeit zu bestimmten Tags, Kategorien, Benutzern sowie den eigenen Freunden oder Suchanfragen RSS-Feeds zu abonnieren oder besondere Gruppen anzulegen, Gruppen beizutreten und diese auch als RSS-Feed zu abonnieren. Zudem kannst Du Foren gründen und Foren beitreten. Blogger haben die Möglichkeit automatisch einen Anreißer ihrer Blogposts über ein YiGG-Plugin zu veröffentlichen. Und wer noch kein Blog hat kann sich als Mitglied ein Blog anlegen (<em>benutzername</em>.yiggblogs.de).
        </p>
        <p>
  ...
  <li>
    ...
    <ul>
      ...
      <li>
         <h4>	2.3 Erlöschen des Widerrufsrechts</h4>
        <p>
  ...
  <li>
    <h3>Nutzerkreis/Anmeldung als Mitglied</h3>
    <ul>
      <li>
         <h4>	3.1 Mindestalter </h4>
        <p>
  ...
  <li>
    ...
    <ul>
      ...
      <li>
        <h4>5.2 Pflichten des YiGG Dienst Nutzers</h4>

        <p>
          Dieser Vertrag beinhaltet auch unsere <strong>YiGG-Verhaltensrichtlinien</strong> für eine <strong>angemessene Nutzung des YiGG Dienstes</strong>, insbesondere Deine Rechte und Pflichten in dem Zusammenhang.
        </p>
        <p>
          <strong>BEACHTE:</strong> Du darfst nie zu illegalen Inhalten verlinken und Du darfst keine illegalen Inhalte (z.B. mittel Upload) einstellen oder illegale Inhalte in Foren oder anderweitig verbreiten. Zudem gibt es Einschränkungen bezüglich der Nutzung des YiGG Dienstes. Die Einzelheiten, insbesondere was unter „illegalem Inhalt” zu verstehen ist, erfährst Du in den YiGG.de-Verhaltensrichtlinien . Lies Dir diese vor Nutzung unseres Dienstes daher sorgfältig durch!
        </p>
      </li>
      <li>
        <h4>5.3	Nutzung von YiGG-RSS-Feeds</h4>
        <p>"YiGG stellt in seinem Angebot auch RSS-Feeds zur Verfügung. Diese RSS-Feeds können zur privaten, nicht-kommerziellen Internetnutzung kostenfrei abonniert werden. Zwingende Voraussetzungen für eine Einbindung auf Webseiten Dritter sind jedoch:<br />
          <br />
          * Auf der Webseite des Dritten muss in unmittelbarer Nähe des RSS-Feeds auf YiGG als Informationsquelle verwiesen werden. Dies kann durch Einbindung des unveränderten <a href="/images/yigglogonew.png">YiGG-Logos</a> geschehen oder durch einen schriftlichen Hinweis auf YiGG. Beide Kennzeichnungen müssen mit der URL http://yigg.de verlinkt werden.<br />
          * Jeder über ein RSS-Feed bezogene Beitrag muss direkt auf den identischen Beitrag bei YiGG zurück verlinken."
        </p>
      </li>
      <li>
        <h4>5.4 Verstoß gegen diese Nutzungsbedingungen</h4>
        <p>Gegen die illegale oder unberechtigte Nutzung des YiGG Dienstes werden wir angemessene rechtliche Schritte unternehmen.</p>
        <p>
  ...
  <li>
    <h3>6. Rechte und Pflichten von YiGG.de</h3>
    <ul>
      <li>
        <h4>6.1 Keine überprüfung der Inhalte</h4>
        <p>
    Wir führen keine Überprüfung der Inhalte (z.B. Kommentare, Videos, Bilder, Zeitungsartikel, Forenbeiträge etc.) vor ihrer Verbreitung oder Verlinkung durch. Ebenso prüfen wir nicht, ob die Autoren und/oder Betreiber (z.B. online Zeitungen) etc., auf deren Websites Du auf den eingereichten Inhalt gestoßen bist, damit einverstanden sind, dass Du ihre Inhalte (z.B Artikel, Videos, Bilder) bei YiGG.de mittels Verlinkung einreichst. Der Betreiber einer solchen Website hat eventuell eigene Nutzungsbedingungen, die dies untersagen oder einschränken. Diesbezüglich musst Du Dich selbst informieren. Überhaupt gilt, dass Du für die Inhalte (egal ob fremde oder eigene), die Du im Zusammenhang mit der Nutzung des YiGG.de Dienstes einbringst, sowie für Deine Interaktionen mit anderen Nutzern allein verantwortlich bist. Da wir nicht Betreiber der Websites sind, auf die Du verlinkst, haben wir auch keinerlei Kontrolle darüber. Die Inhalte spiegeln insbesondere nicht unsere Meinungen oder Lebensanschauungen wieder.
      ...
      <li>
        <h4>6.2 Wir beanspruchen keine Rechte an den eingereichten Inhalten</h4>
        <p>
  ...
  <li>
    <h3>7. Laufzeit und Kündigung</h3>
      ...
      <li>
         <h4>7.2 Kündigung</h4>
        <p>Du kannst Deine Mitgliedschaft jederzeit ohne Angabe von Gründen beenden, indem Du uns eine E-Mail mit entsprechendem Inhalt an <a href="mailto:kuendigung@yigg.de">kuendigung@yigg.de</a> sendest. Spätestens fünf (5) Werktage nach Eingang deiner Kündigungs-E-Mail wirst Du als Mitglied gelöscht.
        </p>
        <p>
      ...
      <li>
        <h4>7.3 Außerordentliche Kündigung </h4>
        <p>
  ...
  <li>
    ...
    <p>Wir können nicht gewährleisten, dass die Website bzw. der YiGG Dienst jederzeit erreichbar und fehlerfrei ist oder für einen bestimmten Zweck geeignet sind. Dies gilt insbesondere, soweit der Zugriff auf die YiGG Dienst und die Website aufgrund von Störungen, die außerhalb unserer Sphäre liegen, unmöglich ist.</p>
  </li>
  <li>
     <h3>9.Haftung</h3>
    <p>
...
<p><strong>9.1</strong> Schäden wegen der Verletzung von Körper, Leben oder Gesundheit, die auf einer vorsätzlichen oder fahrlässigen Pflichtverletzung von YiGG.de, eines gesetzlichen Vertreters von YiGG.de oder eines seiner Erfüllungsgehilfen beruhen,
  ...
  <li>
    ...
    <ul>
      <li><h4>10.1 </h4>
      <p>
          Bei Streitigkeiten im Zusammenhang mit dem YiGG Dienst gilt deutsches Recht unter Ausschluss des UN-Kaufrechts (CISG).
        </p>
      </li>
      <li>
        <h4>10.2 </h4>
        <p>
          Für Kaufleute, juristische Personen des öffentlichen Rechts und öffentlich-rechtliche Sondervermögen ist der Gerichtsstand München, Deutschland.
        </p>
      </li>
      <li>
        <h4>10.3 </h4>
