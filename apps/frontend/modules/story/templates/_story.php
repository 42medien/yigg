...
<div class="story_bt_data">
    ...
    <div class="spreadly-button">
         <a href="http://button.spread.ly/?url=<?php echo urlencode($sf_request->getUriPrefix().url_for_story($story, true));?>&social=0&color=ff9500&title=<?php echo urlencode($story->title);?>" 
            target="_blank"
            rel="like">
         </a>
    </div>
