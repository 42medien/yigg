...
var datePickerController = (function datePickerController() {
        ...
        function getLanguageInfo() {
                ...
                return scriptInner.search(/(^[a-z]{2}$)/i) != -1 ? scriptInner.toLowerCase() : (navigator.language ? navigator.language.toLowerCase().replace(/-[a-z]+$/, "") : navigator.userLanguage ? navigator.userLanguage.toLowerCase().replace(/-[a-z]+$/, "") : "en");
        };
        ...
        function datePicker(options) {
                ...
                this.dragDisabled        = "dragDisabled" in options ? !!options.dragDisabled : true;
                ...
                this.updateTable = function(noCallback) {
                        ...
                        */
                        var dt, cName, td, i, currentDate, cellAdded, col, currentStub, abbr,
                        ...
                        cellAdded           = [false, false, false, false, false, false],
                ...
                /*
                        ...
                        bespokeDisabledDates = o.callback("redraw", [o.firstDateShown, o.lastDateShown]);

                        if(bespokeDisabledDates && bespokeDisabledDates.length) {
                                for(var i = 0, bdd; bdd = bespokeDisabledDates[i]; i++) {
                                        if(bdd.search(/^([0-9]{8})$/) != -1) {
                                                o.dynDisabledDates[bdd] = 1;
                                        };
                                };
                        };
                */
                o.dynDisabledDates  = {};
                        for(var curr = 0; curr < 42; curr++) {
                                ...
                                while(abbr.firstChild) abbr.removeChild(abbr.firstChild);
                                ...
                                if((curr > firstColIndex && curr <= (firstColIndex + dpm)) || o.fillGrid) {
                                        ...
                                        if(selectable) {
                                                //abbr.title = printFormattedDate(new Date(currentStub.substr(0,4), currentStub.substr(4,2), dt), o.statusFormat || o.format, true);
                                        ...
                                        abbr.appendChild(document.createTextNode(dt));
                                        ...
                                        td.id = "";
                                        //td.replaceChild(document.createTextNode(nbsp), td.firstChild);

                                        //abbr.replaceChild(document.createTextNode(nbsp), abbr.firstChild);
                                        abbr.appendChild(document.createTextNode(nbsp))
                                };

                                if(o.showWeeks && curr - (row * 7) == 6) {
                                        while(o.wkThs[row].firstChild) o.wkThs[row].removeChild(o.wkThs[row].firstChild);
                                        //o.wkThs[row].innerHTML = cellAdded[row] ? getWeekNumber(cy, cm, curr - firstColIndex - 6) : nbsp;
                                        o.wkThs[row].appendChild(document.createTextNode(cellAdded[row] ? getWeekNumber(cy, cm, curr - firstColIndex - 6) : nbsp));
                                };
                        };
                ...
                this.create = function() {
                        ...
                        for(var rows = 0; rows < 7; rows++) {
                                ...
                                for(var cols = 0; cols < colspanTotal; cols++) {
                                        ...
                                        if(rows === 0 || (this.showWeeks && cols === 0)) {
                                                ...
                                                //col.id = o.id + '-' + (rows === 0 ? "columnheader-" + cols : "rowheader-" + rows);
                                        } else {
                                                col = document.createElement('td');
                                                col.appendChild(document.createElement('span'));
                                        };
                                        ...
                                        row.appendChild(col);
                                        if(!(rows === 0 || (this.showWeeks && cols === 0))) col.appendChild(document.createTextNode(nbsp));
                        ...
                        for (var y = 0; y < colspanTotal; y++) {
                                if(y == 0 && this.showWeeks) {
                                        this.ths[y].removeChild(this.ths[y].firstChild);
                        ...
                        this.abbrs           = this.table.getElementsByTagName('tbody')[0].getElementsByTagName('span');
                        ...
                        if(this.staticPos) {
                                ...
                                if(elem && elem.tagName.search(/select|input/i) != -1) {
                                        ...
                                        if(this.splitDate) {
                                                addEvent(document.getElementById(this.id + splitDateAppend[1]), "change", o.changeHandler);
                                                addEvent(document.getElementById(this.id + splitDateAppend[0]), "change", o.changeHandler);
                                        };
                                };
                                this.visible = true;
                                this.show();
                ...
                this.events = {
                        ...
                        onkeydown: function (e) {
                                ...
                                if(e.ctrlKey || (kc == 33 || kc == 34) || t < o.firstDateShown || t > o.lastDateShown) {
                                        ...
                                        var startPos = Math.max(0, o.date.getDate() - 6),
                                            dt = "cd-" + String(o.date.getFullYear()) + pad(o.date.getMonth()+1) + pad(o.date.getDate());
                        ...
                        ontablemouseover: function(e) {
                                ...
                                case "th":
                                        ...
                                        if(el.className.search(/drag-enabled/) != -1) {
                                                ...
                                                statusText = txt.search(/^(\d+)$/) != -1 ? getTitleTranslation(7, [txt, getWeeksInYear(o.date.getFullYear())]) : getTitleTranslation(9);
                                        };
                                        break;
                                case "span":
                                        if(!o.statusBar) { break; };
        ...
        datePicker.prototype.setRangeLow = function(range) {
                ...
                if(this.staticPos) this.updateTable(true);
        };
        ...
        datePicker.prototype.setDisabledDates = function(dateArray) {
                ...
                this.disabledDates = disabledDateObj;
                if(this.staticPos) this.updateTable(true);
        };
        ...
        datePicker.prototype.getDisabledDates = function(y, m) {
                ...
                for(var dt in this.disabledDates) {
                        ...
                        //alert("disabled:" + dt1 + " " + dt2);

                        if(dt2 == 1) {
                                //alert(lower + " lu " + upper);
        ...
        datePicker.prototype.setDateFromInput = function() {
                ...
                var elem = this.getElem(), dt;
                if(!elem || elem.tagName.search(/select|input/i) == -1) return;

                if(!this.splitDate) {
                        dt = parseDateString(elem.value, this.format);
                } else {
        ...
        // Do the locale import
        if(typeof(fdLocale) != "object" && languageinfo != "en") {
                var scriptFiles = document.getElementsByTagName('head')[0].getElementsByTagName('script'),
                    loc         = scriptFiles[scriptFiles.length - 1].src.substr(0, scriptFiles[scriptFiles.length - 1].src.lastIndexOf("/")) + "/lang/" + languageinfo + ".js",
        ...
        var showDatePicker = function(inpID) {
                ...
                // Do we need to recreate the datepicker HTML?
                ...
                for(var pt = 0, part; part = parts[pt]; pt++) {
                        ...
                        switch(part) {
                                ...
                                case "F": // A full textual representation of a month, such as January or March
                                                l = part == "M" ? localeDefaults.monthAbbrs : localeDefaults.fullMonths;
                                                for(var i = 0; i < 12; i++) {
        ...
        var parseCallbacks = function(cbs) {
                ...
                for(var i = 0, fn; fn = cbs[i]; i++) {
                        type = fn.match(/(cb_(dateselect|redraw|create|beforechange|afterchange)_)([^\s|$]+)/i)[1].replace(/^cb_/i, "").replace(/_$/, "");
                        fn   = fn.replace(/cb_(dateselect|redraw|create|beforechange|afterchange)_/i, "").replace(/-/g, ".");
                        //type = type.replace(/^cb_/i, "").replace(/_$/, "");
                ...
                for(var i = 0, elem; elem = formElements[i]; i++) {
                        if(elem.className && (elem.className.search(dateFormat) != -1 || elem.className.search(/split-date/) != -1) && ((elem.tagName.toLowerCase() == "input" && (elem.type == "text" || elem.type == "hidden")) || elem.tagName.toLowerCase() == "select")) {
                                ...
                                options = {
                                        ...
                                        dragDisabled:elem.className.search(/disable-drag/i) != -1,
                                        positioned:false,
                                ...
                                if(dts) {
                                        for(t = 0; t < dts.length; t++) {
                                                ...
                                                //alert( "parts:" + parts[0] + " = " + options.disabledDates[parts[0]]  );
                                        };
                                };
                                ...
                                if(dts) {
                                        for(t = 0; t < dts.length; t++) {
                                                ...
                                                //alert( "enabled parts:" + parts[0] + " = " + options.enabledDates[parts[0]]  );
                                        };
                                };

                                // Split the date into three parts ?
                                if(elem.className.search(/split-date/) != -1 && document.getElementById(elem.id+splitAppend[0]) && document.getElementById(elem.id+splitAppend[1]) && document.getElementById(elem.id+splitAppend[0]).tagName.search(/input|select/i) != -1 && document.getElementById(elem.id+splitAppend[1]).tagName.search(/input|select/i) != -1) {
                                        options.splitDate = 1;
                                };
