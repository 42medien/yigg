 ...
 * @subpackage video
 */
class yiggCollegehumorVideo extends yiggExternalVideoSupport implements yiggExternalVideoInterface
{
  /**
  ...
  {
    return self::formatUrl('http://www.collegehumor.com/video:%s/', $id);
  }
  ...
  {
    return self::matchUrl($url, '/^http:\/\/www.collegehumor.com\/video:([0-9]+)$/i', 1);
  }
  ...
  {
    $partial = new sfPartialView( sfContext::getInstance(), "video","_collehumor","");
...
yiggExternalVideoFactory::registerFactoryClass('yiggCollegehumorVideo');